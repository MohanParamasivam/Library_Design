...
public class swaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Library API")
				.description("Library API referenvce for developers")
				.termsOfServiceUrl("http://fakelibrary.com")
				.contact(new Contact ("Library API","http://fakelibrary.com", "fakelibraray@gmail.com"))
				.license("Libraray License")
